...
As mentioned (above)[#choice-of-priors], trying out different weakly informative priors yielded similar results. So, in order to avoid clutter we chose not to include more results since the figures are almost the same (with the exception of maximum 1 result).
